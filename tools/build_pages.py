...
--radius:8px;
/* タイプスケール（7段階に統一）: hero / page(h1) / section(h2) / 1.1(小見出し・カード見出し) / 1.0(本文) / .9(メタ・補助) / .8(バッジ・細字） */
--text-hero:clamp(1.5rem,5vw,2.4rem);--text-page:clamp(1.35rem,4.4vw,1.6rem);--text-section:1.3rem;--text-section-sub:1.1rem;
--text-card-title:1.1rem;--text-lead:1rem;--text-input:1rem;--text-body:1rem;--text-ui:1rem;
--text-nav:.9rem;--text-sm:.88rem;--text-xs:.84rem;--text-2xs:.8rem;--text-chip:.78rem;--page-gutter:32px}
...
/* Spec table (detail) */
table.spec{width:100%;border-collapse:collapse;background:#fff;border:1px solid var(--gray-200);border-radius:var(--radius);overflow:hidden;font-size:var(--text-ui)}
...
.roadmap{margin:.4em 0 .8em}.roadmap h3{font-size:var(--text-ui);margin:.7em 0 .5em;color:var(--gray-800)}
...
.rm-num{flex-shrink:0;display:flex;align-items:center;justify-content:center;width:24px;height:24px;border-radius:50%;background:var(--gray-200);color:var(--gray-700);font-size:var(--text-xs);font-weight:700;font-variant-numeric:tabular-nums}
...
.rm-badge{flex-shrink:0;font-size:var(--text-2xs);font-weight:700;color:#fff;background:var(--accent);border-radius:4px;padding:2px 7px;white-space:nowrap}
...
.careers-sec h2,.materials-sec h2,.rel-certs h2,.rel-links h2,.occ-work h2,.occ-salary h2{font-size:var(--text-section-sub);margin:.2em 0 .4em}
...
.pr-badge{display:inline-block;background:var(--gray-400);color:#fff;font-size:var(--text-2xs);font-weight:700;padding:1px 6px;border-radius:4px;margin-left:8px;vertical-align:middle;letter-spacing:.05em}
...
.mat-kind{flex:0 0 auto;background:var(--accent-light);color:var(--accent-hover);border:1px solid rgba(42,122,110,.18);border-radius:6px;font-size:var(--text-2xs);font-weight:700;padding:2px 8px;margin-top:2px}
...
.rel-certs h3{font-size:var(--text-ui);margin:.7em 0 .2em;color:var(--gray-800)}
...
.occ-stat{display:inline-block;background:var(--accent-light);color:var(--accent-hover);border:1px solid rgba(42,122,110,.18);border-radius:6px;font-size:var(--text-2xs);padding:1px 8px;margin-right:6px}
.occ-work{margin:14px 0 0}.occ-work p{margin:.2em 0}
.occ-salary{margin:14px 0 0}
.salary-range{font-size:var(--text-section-sub);font-weight:700;color:var(--accent);margin:.1em 0}
.occ-salary-note{font-size:var(--text-2xs)}
.occ-skills{display:flex;flex-wrap:wrap;gap:2px 0}
.hub-grp{font-size:var(--text-ui);margin:1.1em 0 .3em;color:var(--accent-hover);border-bottom:1px solid var(--gray-200);padding-bottom:3px}
...
.detail-audience{font-size:var(--text-lead);color:var(--gray-700);line-height:1.65;margin:0 0 18px}
...
.detail-nav-heading,.detail-nav-head{font-size:var(--text-nav);font-weight:700;color:var(--ink-deep);margin:0 0 18px;line-height:1.35}
.detail-nav-subhead{font-size:var(--text-xs);font-weight:600;color:var(--gray-700);margin:0 0 10px}
...
.detail-nav-note{font-size:var(--text-xs);color:var(--gray-500);margin-top:12px;line-height:1.55}
...
.detail-section-title{font-size:var(--text-section-sub);font-weight:600;color:var(--ink-deep);margin:0 0 10px}
.detail-related{margin:18px 0 0;border-top:1px solid var(--gray-200);padding-top:14px}
.detail-related h3{font-size:var(--text-ui);margin:.9em 0 .35em;color:var(--gray-800)}
