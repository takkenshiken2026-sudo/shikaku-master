...
def detail_nav_html(slug, cat, rel_links, vs_pairs):
    ...
    if rel:
        ...
        if rel["combo"]:
            subs.append(
                '<h3 class="detail-nav-subhead">あわせて取りたい資格（ダブルライセンス）</h3>'
                '<ul class="detail-link-list">'
...
--radius:8px;
/* タイプスケール（4段階）: xl=大見出し / lg=小見出し / md=本文 / sm=補助・メタ */
--text-xl:clamp(1.375rem,4vw,2.25rem);--text-lg:1.125rem;--text-md:1rem;--text-sm:0.875rem;--page-gutter:32px}
*{box-sizing:border-box}
html{font-size:16px}
body{margin:0;min-height:100vh;display:flex;flex-direction:column;font-family:"Noto Sans JP",system-ui,-apple-system,"Hiragino Kaku Gothic ProN",Meiryo,sans-serif;font-size:var(--text-md);color:var(--ink);background:var(--page-bg);line-height:1.7;-webkit-font-smoothing:antialiased;overflow-wrap:break-word}
...
.logo{color:#fff;font-weight:700;font-size:1.2rem;text-decoration:none;letter-spacing:.02em}
.logo:hover{color:var(--gray-300);text-decoration:none}
.site-tagline{color:var(--gray-400);font-size:var(--text-sm);font-weight:400;line-height:1.3}
...
.header-nav a{color:var(--gray-300);font-size:var(--text-sm);text-decoration:none;padding:6px 8px;white-space:nowrap;border-radius:4px}
...
.header-nav-sep{color:var(--gray-600);font-size:var(--text-sm);user-select:none;padding:0 1px}
...
.header-search-form input{flex:1;min-width:0;padding:10px 14px;border:1px solid var(--gray-700);border-radius:var(--radius);background:rgba(255,255,255,.06);color:#fff;font-size:var(--text-md);font-family:inherit}
...
.header-menu-panel a{color:var(--gray-300);text-decoration:none;padding:12px 4px;border-bottom:1px solid var(--gray-800);font-size:var(--text-md)}
...
.hero-sub{font-size:var(--text-md);color:var(--gray-800);line-height:1.75;max-width:40em;margin:0}
.hero-search{margin-top:18px;max-width:520px;position:relative}
.hero-search input{width:100%;padding:12px 16px 12px 42px;border:1px solid var(--gray-300);border-radius:var(--radius);font-size:var(--text-md);background:#fff;color:var(--gray-900);font-family:inherit}
...
.block-head p{font-size:var(--text-sm);color:var(--gray-500);margin:0}
.block-all-certs{padding:52px var(--page-gutter) 56px;margin-bottom:0}
.block-all-certs .block-head{margin-bottom:24px}
.card-link{position:relative}
.card-link::after{content:"→";position:absolute;right:12px;top:14px;font-size:var(--text-sm);font-weight:600;color:var(--gray-400);opacity:0;transition:opacity .15s,color .15s;pointer-events:none}
...
.popular-more a,.field-more a,.compare-more a{font-size:var(--text-md);font-weight:600;color:var(--gray-800);text-decoration:underline;text-underline-offset:2px}
...
.purpose-card h3{font-size:var(--text-lg);font-weight:700;margin:0 0 4px;color:var(--ink-deep)}
.purpose-card-for{font-size:var(--text-sm);color:var(--gray-600);line-height:1.5;margin:0}
.purpose-card::after{content:"→";position:absolute;right:12px;top:14px;font-size:var(--text-sm);font-weight:600;color:var(--gray-400);opacity:0;transition:opacity .15s,color .15s;pointer-events:none}
...
.block-all-certs .filter-field label{display:block;font-size:var(--text-sm);color:var(--gray-700);margin-bottom:6px;font-weight:600}
...
.field-card h3{font-size:var(--text-md);font-weight:600;line-height:1.35;color:var(--ink-deep);margin:0}
.field-count{flex-shrink:0;margin-top:1px;padding:3px 7px;border-radius:4px;font-size:var(--text-sm);font-weight:600;color:var(--gray-700);background:var(--gray-100);border:1px solid var(--gray-200);line-height:1.2;white-space:nowrap}
.field-examples{font-size:var(--text-sm);color:var(--gray-500);line-height:1.45;margin:0}
...
.compare-tag{font-size:var(--text-sm);font-weight:600;color:var(--gray-500);letter-spacing:.04em;margin-bottom:6px}
...
/* Lists / search */
h1{font-size:var(--text-xl);margin:.1em 0 .35em;color:var(--ink-deep);font-weight:700}
h2{color:var(--ink-deep)}
.lead{color:var(--gray-700);font-size:var(--text-md);margin:0 0 14px}
...
.ctl-l{font-size:var(--text-sm);font-weight:600;color:var(--gray-500);letter-spacing:.02em}
...
.cl-rank{flex-shrink:0;display:flex;align-items:center;justify-content:center;min-width:30px;font-weight:700;font-size:var(--text-lg);color:var(--gray-400);font-variant-numeric:tabular-nums;line-height:1}
...
.cl-name{font-size:var(--text-md);font-weight:600;color:var(--gray-900);line-height:1.4}
...
.crumbs{font-size:var(--text-sm);color:var(--gray-500);margin-bottom:10px}
.crumbs a{color:var(--gray-700)}

/* Badges (subtle) */
.badge{display:inline-block;padding:1px 8px;border-radius:4px;font-size:var(--text-sm);font-weight:600;border:1px solid var(--gray-300);color:var(--gray-700);background:var(--gray-100);vertical-align:middle}
...
/* Spec table (detail) */
table.spec{width:100%;border-collapse:collapse;background:#fff;border:1px solid var(--gray-200);border-radius:var(--radius);overflow:hidden;font-size:var(--text-md)}
.spec-wrap{border:1px solid var(--gray-200);border-radius:var(--radius);overflow:hidden;background:#fff}
...
.tag-chip{display:inline-block;background:var(--gray-100);color:var(--gray-700);border:1px solid var(--gray-200);border-radius:12px;padding:2px 10px;margin:2px 4px 2px 0;font-size:var(--text-sm)}
...
.roadmap{margin:.4em 0 .8em}.roadmap h3{font-size:var(--text-md);margin:.7em 0 .5em;color:var(--gray-800)}
...
.rm-num{flex-shrink:0;display:flex;align-items:center;justify-content:center;width:24px;height:24px;border-radius:50%;background:var(--gray-200);color:var(--gray-700);font-size:var(--text-sm);font-weight:700;font-variant-numeric:tabular-nums}
...
.careers-sec h2,.materials-sec h2,.rel-certs h2,.rel-links h2,.occ-work h2,.occ-salary h2{font-size:var(--text-lg);margin:.2em 0 .4em}
...
.ad-disclosure{font-size:var(--text-sm);color:var(--gray-600);background:#fbf6ee;border:1px solid #efe1c8;border-radius:8px;padding:9px 12px;margin:0 0 10px}
...
.mat-kind{flex:0 0 auto;background:var(--accent-light);color:var(--accent-hover);border:1px solid rgba(42,122,110,.18);border-radius:6px;font-size:var(--text-sm);font-weight:700;padding:2px 8px;margin-top:2px}
.mat-body{flex:1}.mat-note{display:block;color:var(--gray-500);font-size:var(--text-sm);margin-top:2px}
.mat-foot{font-size:var(--text-sm);margin:.4em 0 0}
.rel-certs h3{font-size:var(--text-md);margin:.7em 0 .2em;color:var(--gray-800)}
...
.occ-stats-label{font-size:var(--text-sm);color:var(--gray-700);font-weight:600;margin-right:4px}
...
.hub-grp{font-size:var(--text-md);margin:1.1em 0 .3em;color:var(--accent-hover);border-bottom:1px solid var(--gray-200);padding-bottom:3px}
.vs-table{width:100%;border-collapse:collapse;margin:14px 0;font-size:var(--text-sm)}
...
.feature-nav h3{font-size:var(--text-md);font-weight:600;color:var(--gray-800);margin:.9em 0 .3em}
...
.cmpbar-lbl{font-size:var(--text-sm);color:var(--gray-400)}
...
.cmpbar .btn-ghost{background:transparent;color:var(--gray-300);border:1px solid var(--gray-600);padding:6px 13px;border-radius:var(--radius);cursor:pointer;font:inherit;font-size:var(--text-sm)}
...
table.cmp th,table.cmp td{text-align:left;padding:10px 14px;border-bottom:1px solid var(--gray-200);border-right:1px solid var(--gray-200);vertical-align:top;font-size:var(--text-sm);min-width:150px}
...
.site-footer-note{font-size:var(--text-sm);color:var(--gray-500);line-height:1.65;margin:0 0 8px;max-width:54em}
.site-footer-copy{font-size:var(--text-sm);color:var(--gray-400);line-height:1.5;margin:0}
...
.sfp-label{font-size:var(--text-sm);font-weight:700;color:var(--gray-700)}
...
.partner-card-tag{font-size:var(--text-sm);color:var(--gray-700);line-height:1.45}
...
.pd-name{font-size:var(--text-md);font-weight:700;color:var(--accent-hover)}
...
.detail-audience{font-size:var(--text-md);color:var(--gray-700);line-height:1.65;margin:0 0 18px}
...
.detail-nav-heading,.detail-nav-head{font-size:var(--text-sm);font-weight:700;color:var(--ink-deep);margin:0 0 18px;line-height:1.35}
.detail-nav-subhead{font-size:var(--text-sm);font-weight:600;color:var(--gray-700);margin:0 0 10px}
...
.detail-link-item{font-size:var(--text-sm);line-height:1.55;color:var(--gray-600)}
...
.detail-link-desc{color:var(--gray-500);font-weight:400}
...
.detail-compare-row{font-size:var(--text-sm);color:var(--gray-600);line-height:1.65;margin:0}
.detail-compare-label{color:var(--gray-500);font-weight:400}
...
.detail-nav-note{font-size:var(--text-sm);color:var(--gray-500);margin-top:12px;line-height:1.55}
...
.fact .l{font-size:var(--text-sm);color:var(--gray-500)}
.fact .v{font-size:var(--text-sm);font-weight:600;color:var(--ink-deep)}
...
.detail-section-title{font-size:var(--text-lg);font-weight:600;color:var(--ink-deep);margin:0 0 10px}
.detail-related{margin:18px 0 0;border-top:1px solid var(--gray-200);padding-top:14px}
.detail-related h3{font-size:var(--text-md);margin:.9em 0 .35em;color:var(--gray-800)}
.detail-related h3:first-of-type{margin-top:.2em}
.detail-related ul{margin:.2em 0;padding-left:1.1em}
.detail-related .more-compare p{margin:.2em 0;line-height:1.55;color:var(--gray-700);font-size:var(--text-md)}
...
.detail-source-note{margin-top:8px;color:var(--gray-500);font-size:var(--text-sm)}
.detail-points{margin:0 0 22px}
.point-list{list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:7px}
.point-list li{position:relative;padding:8px 12px 8px 32px;background:var(--accent-light);border:1px solid rgba(42,122,110,.15);border-radius:var(--radius);font-size:var(--text-md);color:var(--gray-800);line-height:1.55}
...
.result-label{display:inline-block;font-size:var(--text-sm);font-weight:600;color:var(--gray-600);background:var(--gray-100);border:1px solid var(--gray-300);border-radius:4px;padding:1px 6px;margin-left:6px;vertical-align:middle}
...
.cmp-verdict-card .pickname{font-size:var(--text-md);font-weight:700;color:var(--ink-deep);line-height:1.4}
.cmp-verdict-card .pickname a{color:var(--ink-deep);text-decoration:underline;text-underline-offset:2px}
.cmp-verdict-card .why{font-size:var(--text-sm);color:var(--gray-600);margin-top:3px;line-height:1.5}
...
.page-detail .mat-kind{background:var(--gray-100);color:var(--gray-700);border-color:var(--gray-200);font-size:var(--text-sm)}
...
.page-detail .partner-detail .detail-section-title{font-size:var(--text-lg)}
...
.page-detail .detail-roadmap .roadmap h3{font-size:var(--text-lg);font-weight:700;color:var(--ink-deep);margin:0 0 10px}
