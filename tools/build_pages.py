...
.header-nav-cta{margin-left:8px;padding:7px 12px;background:var(--accent);color:#fff !important;font-weight:600;border-radius:var(--radius);line-height:1.2;text-decoration:none}
