...
.page-detail table.spec .materials a{color:var(--accent);font-weight:400;text-decoration:none}
.page-detail table.spec .materials a:hover{color:var(--accent-hover);text-decoration:underline;text-underline-offset:2px}
.page-detail table.spec .mat-kind{display:inline;background:none;border:none;padding:0;margin:0;font-weight:400;color:var(--ink)}
