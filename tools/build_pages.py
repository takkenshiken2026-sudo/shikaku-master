...
.hero-search input{width:100%;padding:15px 18px 15px 46px;border:none;border-radius:12px;font-size:1.0625rem;background:#fff;color:var(--ink);font-family:inherit;box-shadow:0 8px 28px rgba(6,20,40,.35)}
...
.article-table th{background:var(--gray-50);font-weight:700;white-space:nowrap;font-size:1rem}
...
.vs-table thead th{background:var(--gray-100);color:var(--ink-deep);text-align:center;font-size:1rem}
.vs-table tbody th{background:var(--gray-50);white-space:nowrap;width:var(--vs-label-w);font-size:1rem}
...
.page-detail{--detail-body:1.125rem;--detail-body-lh:1.9;--detail-h1:clamp(1.75rem,3.2vw,2.125rem);--detail-h2:1.5rem;--detail-h3:1.125rem;--detail-section-y:52px;--detail-block-gap:32px;max-width:none;width:100%;font-size:var(--detail-body);line-height:var(--detail-body-lh);color:var(--ink)}
