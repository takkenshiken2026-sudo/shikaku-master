...
.guide-card{background:#fff;border:1px solid var(--gray-200);border-left:3px solid var(--gray-300);border-radius:var(--radius);padding:16px 18px;box-shadow:0 1px 3px rgba(0,0,0,.06)}
.guide-card--suited{border-left-color:#6a9e94}
.guide-card--study{border-left-color:var(--accent)}
.guide-card--steps{background:var(--accent-light);border-color:rgba(35,111,100,.18);border-left-color:var(--accent)}
.guide-card--career{border-left-color:#8a9478}
...
.guide-card--steps .guide-h{border-bottom-color:rgba(35,111,100,.15)}
.guide-card-body p{margin:0;line-height:1.75;color:var(--ink)}
.detail-guide .guide-note{font-size:var(--text-sm);color:var(--muted);margin:14px 0 0;padding:12px 14px;background:var(--gray-50);border:1px solid var(--gray-200);border-radius:var(--radius);line-height:1.65}
.guide-steps{list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:8px;counter-reset:guide-step}
.guide-steps li{position:relative;margin:0;padding:10px 12px 10px 44px;background:#fff;border:1px solid rgba(35,111,100,.14);border-radius:var(--radius);line-height:1.65;color:var(--ink);counter-increment:guide-step}
...
.diff-veryeasy{color:var(--accent-hover);background:var(--accent-light);border-color:rgba(35,111,100,.22)}
