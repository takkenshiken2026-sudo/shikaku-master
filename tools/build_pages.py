...
.field-card h3{font-size:var(--text-lg);font-weight:var(--fw-semibold);line-height:1.35;color:var(--ink-deep);margin:0}
...
.spec-section-title{font-size:var(--text-lg);font-weight:var(--fw-semibold);color:var(--ink-deep);margin:0 0 8px;line-height:1.4}
