...
.page-detail table.spec .materials a,.page-detail table.spec .spec-list a,.page-detail table.spec .jobtag a{color:var(--ink);font-weight:var(--fw-regular);font-size:inherit;text-decoration:underline;text-underline-offset:2px}
.page-detail table.spec .materials a:hover,.page-detail table.spec .spec-list a:hover,.page-detail table.spec .jobtag a:hover{color:var(--ink);opacity:.85}
