...
.all-certs-table thead th{text-align:left;padding:11px 14px;background:#edf2f8;color:var(--ink);font-weight:var(--fw-semibold);font-size:var(--text-table);border-bottom:2px solid #cddbeb;white-space:nowrap}
